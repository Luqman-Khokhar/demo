...
const SideNavContent = (props) => {
	...
	return (
		<Menu
			...
			style={{ height: "100%", borderRight: 0 ,color:"#B19541" }}
...
const TopNavContent = () => {
	...
	return (
		<Menu 
			mode="horizontal" 
			style={{ backgroundColor: topNavColor , color:"#B19541"}}
			items={menuItems}
		/>
	);
};
...
const MenuContent = (props) => {
	return props.type === NAV_TYPE_SIDE ? (
		<SideNavContent className="" style={{color:"#B19541"}}{...props} />
	) : (
		<TopNavContent className="" style={{color:"#B19541"}} {...props} />
	);
};
